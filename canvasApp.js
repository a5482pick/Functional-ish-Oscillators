...
//encapsulated in value 'x' at t = 0.
function runAnimation(x)  {

     //Parameter t increases incrementally with each call to 'display(x)'.
     var t = 0;
     
     setInterval(display, 20, x, t);
     ...
     function display(x)  {
          ...
          drawMasses( imageData3( imageData2( imageData1( drawScreen( x, t ) ) ) ) ) ;                                          
    }
}
...
//Calculate and plot spring k2.  The unevaluated inner function 'f'is passed (instead of f())
//to demonstrate passing functions as parameters. 
function imageData2(f) {
...
//Calculate and plot spring k3.  The unevaluated inner function 'f'is passed (instead of f())
//to demonstrate passing functions as parameters. 
function imageData3(f)  {
